    ...
    <div className={classes.PetFormulary}>
      ...
      <form className={classes.Form} onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <FormLabel component="legend">O pet é um cachorro ou um gato?</FormLabel>
            <RadioGroup
              aria-label="pet-type"
              name="pet-type1"
              {...register("Type")}
        ...
        <span className={classes.Terms}>
          Ao cadastrar um pet, você concorda com a Política dos Pets e os
